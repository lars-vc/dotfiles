...
return packer.startup(function(use)
	...
	use({
		...
		cmd = { "RnvimrToggle" },
		config = function()
			-- Need to install ranger and pynvim locally (pip3 install pynvim), maybe also ranger via python but not sure
	...
	use({
		...
		cmd = { "TodoTrouble", "TroubleToggle", "TroubleOpen" },
	})
	use({
	...
	--==Abolish==--
	-- needs sed, ripgrep and devicons
	use({ "nvim-pack/nvim-spectre", opt = true, module = "spectre" })
